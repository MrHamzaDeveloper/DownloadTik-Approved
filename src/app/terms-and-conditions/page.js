  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto p-4">
        <h1 className="text-3xl font-bold text-center mb-6">Terms and Conditions for DownloadTik</h1>
        ...
        <p className="mb-4">
          All content on our website, including text, graphics, logos, and images, is the property of DownloadTik or our content suppliers and is protected by copyright and intellectual property laws. You may not reproduce, distribute, or modify any content without our written permission.
        </p>
        ...
        <p className="mb-4">
          In no event shall DownloadTik or its affiliates be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from or related to your use of our service.
        </p>
